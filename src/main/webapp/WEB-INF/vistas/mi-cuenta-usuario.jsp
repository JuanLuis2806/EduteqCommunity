    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a data-toggle="tab" href="#cuenta">Datos de la Cuenta</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="perfil" class="tab-pane active"><br>
                    ...
                    <form class="form" action="##" method="post" id="registrationForm">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="division"><h4>Divisiones</h4></label>
                                <input type="hidden" id="divisionId" value="${usuario.idDivision.id}"/>
                                <select class="select-css" id="divisiones" name="divisiones">
...
<script src="js/mi-cuenta-usuario.js"></script>