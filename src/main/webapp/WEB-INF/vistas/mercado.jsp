                            ...
                            <form id="subir-producto">
                                <div class="single-blog-post mb-50 wow fadeInUp" data-wow-delay="300ms">
                                    <div align="center" class="blog-post-thumb mb-50">
                                        <input name="imagen-producto" id="imagen-producto" type="file" class="text-center center-block file-upload">
                                    </div>
                                    <label>Matricula:</label>
                                    <a  class="post-date">${usuario.getMatricula()}</a><br>
                                    <label>Producto:</label>
                                    <a  class="post-meta">
                                        <input type="text" class="form-control" name="nombre-producto" id="nombre-producto" placeholder="Producto o Servicio" title="Debes llenar este campo"><br></a>
                                    <label>Descripción:</label>
                                    <div class="post-meta">
                                        <a>    <input type="text" class="form-control" name="descripcion-producto" id="descripcion-producto" placeholder="Descripción de producto o servicio" title="Debes llenar este campo"></a>
                                    </div>
                                    <label>Precio:</label>
                                    <div class="post-date">
                                        <a>    <input type="number" class="form-control" name="precio-producto" id="precio-producto" placeholder="Precio del producto o servicio" title="Debes llenar este campo"></a>
                                    </div>
